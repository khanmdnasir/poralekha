...
export default function FindBookScreen({ navigation }) {
    ...
    return (
        <View style={{flex:1}}>
            ...
            <View style={{flex:7,backgroundColor:'#EEF4F6',paddingLeft:30,paddingRight:30,paddingTop:10}}>
                <View style={{flexDirection:'row'}}>
                    <View>
                        <Text style={{color:'#000000',fontSize:16}}>There are 400+ Books</Text>
                        <Text style={{color:'#000000',fontSize:16}}>in store</Text>
                    </View>
