...
export default function FindSkillCourseScreen({ navigation }) {
    ...
    return (
        <View style={{flex:1}}>
            ...
            <View style={{flexDirection:'row'}}>
                    <View>
                        <Text style={{color:'#000000',fontSize:16}}>There are 400+ Skill</Text>
                        <Text style={{color:'#000000',fontSize:16}}>Based Course</Text>
                    </View>
