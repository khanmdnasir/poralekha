    ...
    return (
        <View style={{flex:1}}>
            ...
            <View style={{flex:7,backgroundColor:'#EEF4F6',padding:30}}>
               <Image source={require('../components/images/notification.png')} style={{alignSelf:'center',marginTop:50}}/>
               <Text style={{color:'#380E86',fontSize:18,alignSelf:'center',marginTop:20}}>No notification yet</Text>
